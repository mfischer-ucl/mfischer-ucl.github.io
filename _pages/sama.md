...
<div class="row" style="margin: 50px 0 50px 0">
    <div style="display: inline">
        <ul style="list-style: none; text-align: center">
            <li class="horizItem">
                <a href="https://arxiv.org/abs/2411.19322">
            ...
            <li class="horizItem">
                ...
                <img class="teaserbutton" src="/assets/images/database_icon.png" ><br>
                    <h4><strong>Data & Model (GDrive)</strong></h4>
                </a>
            </li>
            <li class="horizItem">
                <a href="https://huggingface.co/datasets/Voxel51/sama_material_centric_video_dataset">
                <img class="teaserbutton" src="/assets/images/hf_icon.png" ><br>
                    <h4><strong>Dataset (HF)</strong></h4>
                </a>
            </li>
            <li class="horizItem">
...
We thank <a href="https://github.com/harpreetsahota204">Harpreet Sahota</a> for adding the dataset to Huggingface! 
